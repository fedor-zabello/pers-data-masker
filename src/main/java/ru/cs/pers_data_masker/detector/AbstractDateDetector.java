...
/**
 * Базовый детектор дат. Поддерживает числовые форматы (дд.мм.гггг, мм.дд.гггг,
 * гггг.дд.мм, дд/мм/гггг, дд-мм-гггг, дд мм гггг, ддммгггг) и дату с месяцем
 * текстом («15 января 1990»). Подкласс задаёт контекстную проверку
 * (рождение / выдача).
 */
